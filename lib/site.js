...
class Site
{
    ...
    {
        this.express.use('/keppler', express.static(path.join(__dirname, '../app/dist')))

        // Project download route
        this.express.get('/keppler/' + _project.slug + '/download', (request, response) =>
        {
            // Get zip buffer
        ...
        this.express.use('/keppler/' + _project.slug + '/files', express.static(_project.path))
    }
}
